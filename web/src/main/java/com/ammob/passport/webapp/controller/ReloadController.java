...
import com.ammob.passport.webapp.listener.StartupListener;
...
public class ReloadController {
    ...
    throws Exception {
        ...
        if (referer != null) {
            ...
            List<String> messages = (List<String>) request.getSession().getAttribute(BaseFormController.MESSAGES_SUCESS_KEY);
