...
public class StartupListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent event) {
        ...
        if (context.getInitParameter(Constants.STATIC_RESOURCE_URI) != null) {
            config.put(Constants.STATIC_RESOURCE_URI, context.getInitParameter(Constants.STATIC_RESOURCE_URI));
        }
